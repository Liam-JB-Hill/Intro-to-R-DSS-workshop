...
There are several upsides (plus a few challenges) associated with learning to use R but it is an especially useful tool for those who want to do [Open Science/Research](https://support-for-researchers.ed.ac.uk/getting-started/doing-research/open-research) and apply an [Open approach to Analysis](https://doi.org/10.1177/0022219420945267)^[van Dijk et al. (2020) https://doi.org/10.1177/0022219420945267]. I've summarised several of these in this first section. 

:::: {.boxout data-latex=""}
::: {.center data-latex=""}
**Top tip/pointer:**
:::
If you don't need any convincing or persuading to use R (i.e. you're not reading this wondering 'Why should I learn this?') feel free to skip over section 1 and get on with working through the more practical sections that come later. 
::::
<br>
...
*Note:* the numbering of these section in the image below correspond to the numbering of the sub-sections that follow here. 
